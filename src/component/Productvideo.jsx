...
export default function App() {
  ...
  // Glow intensity based on mouse movement
  ...
  return (
    ...
    >
      <div className="max-w-7xl w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-32 bg-white p-6 lg:p-16 rounded-3xl shadow-2xl">
        ...
        {/* --- Left Column: Floating, Rotating, Lifting & Glowing Video --- */}
        <div className="relative w-full lg:w-1/2 flex items-center justify-center">
          ...
          <div
            ...
            style={{
              transform: `translate3d(${mouseOffset.x * videoTranslate}px, ${
                mouseOffset.y * videoTranslate
              }px, 0) rotateY(${mouseOffset.x * videoRotate}deg) rotateX(${
                -mouseOffset.y * videoRotate
              }deg) scale(${1 + Math.min(Math.abs(mouseOffset.x), Math.abs(mouseOffset.y)) * (videoScale - 1)})`,
        ...
        {/* --- Right Column: Floating & Rotating Text --- */}
        <div
          className="w-full lg:w-1/2 flex flex-col justify-center text-gray-800 text-center transition-transform duration-200 ease-out"
          style={{
            transform: `translate3d(${-mouseOffset.x * textTranslate}px, ${
              -mouseOffset.y * textTranslate
            }px, 0) rotateY(${-mouseOffset.x * textRotate}deg) rotateX(${
              mouseOffset.y * textRotate
            }deg)`,
            transformStyle: "preserve-3d",
          }}
        >
